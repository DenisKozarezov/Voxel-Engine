...
namespace utils
{
	...
	public:
		...
		static void drawWireframeCube(const glm::vec3& position, const glm::vec3& size, const glm::vec3& color = glm::vec3(0.0f, 1.0f, 0.0f));
		static void drawWireframeCircle(const glm::vec3& position, const float& radius = 1.0f, const glm::vec3& axis = glm::vec3(0.0f, 1.0f, 0.0f));
