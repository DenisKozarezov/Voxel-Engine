...
{
	constexpr static const char* PATH = "resources\\textures\\texture.jpg";
	...
	const bool Renderer::checkValidationLayerSupport() const
	{
		uint32_t layerCount;
	...
	const bool Renderer::checkDeviceExtensionSupport(const VkPhysicalDevice& device) const
	{
	...
	const bool Renderer::isDeviceSuitable(const VkPhysicalDevice& device) const
	{
	...
	constexpr bool Renderer::hasStencilComponent(const VkFormat& format) const
	{
		return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
	}
	const int Renderer::rateDeviceSuitability(const VkPhysicalDevice& device) const
	{
	...
	const QueueFamilyIndices Renderer::findQueueFamilies(const VkPhysicalDevice& device) const
	{
	...
	const SwapChainSupportDetails Renderer::querySwapChainSupport(const VkPhysicalDevice& device) const
	{
	...
	constexpr const VkSurfaceFormatKHR& Renderer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) const
	{
	...
	constexpr const VkPresentModeKHR& Renderer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) const
	{
	...
	constexpr const VkExtent2D Renderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) const
	{
	...
	constexpr const VkFormat Renderer::findSupportedFormat(const std::vector<VkFormat>& candidates, const VkImageTiling& tiling, const VkFormatFeatureFlags& features) const
	{
	...
	constexpr const VkFormat& Renderer::findDepthFormat() const
	{
	...
	const VkResult Renderer::createDebugUtilsMessengerEXT(const VkInstance& instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) const
	{
	...
	const VkShaderModule Renderer::createShaderModule(const std::vector<char>& code) const
	{
	...
	constexpr VkDebugUtilsMessengerCreateInfoEXT Renderer::populateDebugMessengerCreateInfo() const
	{
	...
	const VkImageView Renderer::createImageView(const VkImage& image, const VkFormat& format, const VkImageAspectFlags& aspectFlags) const
	{
	...
	const VkCommandBuffer Renderer::beginSingleTimeCommands() const
	{
	...
	const void Renderer::createInstance()
	{
	...
	const void Renderer::createLogicalDevice()
	{
	...
	const void Renderer::createSurface()
	{
	...
	const void Renderer::createSwapChain()
	{
	...
	const void Renderer::createImageViews()
	{
	...
	const void Renderer::createRenderPass()
	{
	...
	const void Renderer::createGraphicsPipeline()
	{
	...
	const void Renderer::createBuffer(const VkDeviceSize& size, const VkBufferUsageFlags& usage, const VkMemoryPropertyFlags& properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
	{
	...
	const void Renderer::createFramebuffers()
	{
	...
	const void Renderer::createUniformBuffers()
	{
	...
	const void Renderer::createVertexBuffer()
	{
	...
	const void Renderer::createIndexBuffer()
	{
	...
	const void Renderer::createCommandPool()
	{
	...
	const void Renderer::createCommandBuffers()
	{
	...
	const void Renderer::createSyncObjects()
	{
	...
	const void Renderer::createDescriptorSetLayout()
	{
	...
	const void Renderer::createDescriptorPool()
	{
	...
	const void Renderer::createDescriptorSets()
	{
	...
	const void Renderer::createTextureImage()
	{
	...
	const void Renderer::createDepthResources()
	{
	...
	const void Renderer::createImage(const uint32_t& width, const uint32_t& height, const VkFormat& format, const VkImageTiling& tiling, const VkImageUsageFlags& usage, const VkMemoryPropertyFlags& properties, VkImage& image, VkDeviceMemory& imageMemory)
	{
	...
	const void Renderer::copyBuffer(const VkBuffer& srcBuffer, const VkBuffer& dstBuffer, const VkDeviceSize& size)
	{
	...
	const void Renderer::copyBufferToImage(const VkBuffer& buffer, const VkImage& image, const uint32_t& width, const uint32_t& height)
	{
		VkCommandBuffer commandBuffer = beginSingleTimeCommands();
	...
	const void Renderer::endSingleTimeCommands(const VkCommandBuffer& commandBuffer)
	{
	...
	const void Renderer::transitionImageLayout(const VkImage& image, const VkFormat& format, const VkImageLayout& oldLayout, const VkImageLayout& newLayout)
	{
		VkCommandBuffer commandBuffer = beginSingleTimeCommands();
	...
	const void Renderer::recordCommandBuffer(const VkCommandBuffer& commandBuffer, const uint32_t& imageIndex)
	{
		VkCommandBufferBeginInfo beginInfo = {};
		beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
	...
	const void Renderer::setupDebugMessenger()
	{
	...
	const void Renderer::updateUniformBuffer(const uint32_t& currentImage)
	{
	...
	const void Renderer::pickPhysicalDevice()
	{
	...
	const void Renderer::destroyDebugUtilsMessengerEXT(const VkInstance& instance, const VkDebugUtilsMessengerEXT& debugMessenger, const VkAllocationCallbacks* pAllocator)
	{
	...
	const void Renderer::cleanupSwapChain()
	{
	...
	const void Renderer::cleanupUniformBuffers()
	{
		for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) 
		{
	...
	const void Renderer::setGLFWwindow(GLFWwindow* const window) noexcept
	{
		_window = window;
	}
	const void Renderer::renderFrame() 
	{
	...
	const void Renderer::deviceWaitIdle() const
	{
		vkDeviceWaitIdle(_logicalDevice);
	}
